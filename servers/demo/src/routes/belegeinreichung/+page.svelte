...
<div class="flex flex-col lg:flex-row h-full min-h-dvh font-sans">
	<aside class="md:block lg:w-fit bg-secondary-blue px-6 py-4 lg:py-9">
		<h1 class="text-lg font-bold text-white font-sans" aria-label="Belegeinrichtung">
			<svg
				fill="currentColor"
				height="30px"
				width="30px"
	...
	>
		<div class="border rounded-sm border-gray-200 p-3 flex flex-col">
			...
			<div class="flex flex-col gap-4 h-full">
				...
				<div class="flex flex-col gap-2 flex-1 mt-8">
					<h3>
						<span class="px-4 py-2 rounded-full bg-yellow-300 text-3xl">2</span> Befüllen Sie das Formular
						mit den Daten des hochgeladenen Belegs:
					</h3>
					<button
						type="button"
						onclick={fillOutForm}
		...
		<div class="border rounded-sm border-gray-200 p-3 flex flex-col h-full relative">
			<h2 class="font-sans mb-3">
				<span class="px-4 py-2 rounded-full bg-yellow-300">3</span> Belegdaten
			</h2>
			<p class="text-xs">
